...
library(stringr)
MT='A1'
species2=paste("Mv-sup-1065-",MT,sep="")
species1=paste("Mv-lag-1253-",MT,sep="")

chroms_lag=c('MC12','MC16','MC03')
chroms_1=c('tig00000084','tig00000080','tig00000082','tig00000040')

strata=read.table("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/2.make_DS_plot/Mv-sup-1065/with_extra_contig/database_for_strata_Mv-sup-1065.txt", header=T, as.is=T, sep='\t')
strata1=select(strata, c("contig_A1","start_A1","end_A1","colors"))
colnames(strata1)=c('contig','start','end','colors')
strata1$contig=strata1$contig %>% str_replace("Mv-sup-1065-A1_", "")
...
pdf(file = paste("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/3.circos/circos_",MT,"_stratacolor.pdf",sep=''))#, width=200, height=200)
...
contig_color=c("blue","purple","purple","grey","grey","grey","grey")
