...
setwd("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/3.circos/A1vsA2/")
library(circlize)
library(dplyr)
library(tidyr)
library(stringr)

species1=paste("Mv-sup-1065-A1")
species2=paste("Mv-sup-1065-A2")

chroms_lag=c('tig00000084','tig00000080','tig00000040')
chroms2=c('tig00000068','tig00000031')
...
strata2$contig=strata2$contig %>% str_replace("Mv-sup-1065-A2_", "")
...
to_rm=c('tig00000084')
data_centromeres=data_centromeres[-which(data_centromeres$contig %in% to_rm ),]
...
to_inv=c("tig00000040","tig00000084")
...
pdf(file = paste("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/3.circos/A1vsA2/circos_",species1,"-",species2,"_stratacolor.pdf",sep=''))#, width=200, height=200)
