...
chroms_1=c('tig00000068','tig00000031')

strata=read.table("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/2.make_DS_plot/Mv-sup-1065/database_for_strata_Mv-sup-1065.txt", header=T, as.is=T, sep='\t')
strata1=select(strata, c("contig_A2","start_A2","end_A2","colors"))
colnames(strata1)=c('contig','start','end','colors')
strata1$contig=strata1$contig %>% str_replace("Mv-sup-1065-A2_", "")
...
for (contig in to_inv)
{
  ...
  #change the coordinates for the strata database
