...
import sys
species=sys.argv[1]
path_ortholog=f'/home/elise/Assembly/ortholog_reconstruction/1.results/Results_Jun12_2/Orthologues/Orthologues_{species}-A1_final.cds.prot_longest_transcript/'


d_gene={}
bed=open(f'/home/elise/Assembly/ortholog_reconstruction/0.data/GTF_final/{species}-A1_final_fixed.bed','r')
for line in bed:
	line=line.split()
	if line[7]=='gene':
		gene=line[3]
...
d_gene2={}
bed2=open(f'/home/elise/Assembly/ortholog_reconstruction/0.data/GTF_final/{species}-A2_final_fixed.bed','r')
for line in bed2:
	line=line.split()
	if line[7]=='gene':
		#print(line)
...
d={}
f1=open(f'{path_ortholog}/{species}-A1_final.cds.prot_longest_transcript__v__{species}-A2_final.cds.prot_longest_transcript.tsv','r')
f1.readline()
for line in f1:
	line=line.split('\t')
	OG=line[0]
