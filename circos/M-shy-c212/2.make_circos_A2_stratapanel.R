...
#chroms_1=c('h1tg000006l','h1tg000040l','h1tg000077l')
chroms_1=c('h1tg000006l','h1tg000040l')
...
strata1$contig=strata1$contig %>% str_replace("Mv-cat-C212-A2_", "")
...
d=read.table(paste('Mv-Cat/synteny_',species1,'_',species2,'.txt',sep=''), header=T, as.is=T, sep='\t')
