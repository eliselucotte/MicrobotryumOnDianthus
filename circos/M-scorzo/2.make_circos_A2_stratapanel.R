...
##centromere file : @GEEserver13 /home/marine/MS_newSpecies/allGenomes_centromereCoordinates_newSpecies.tab
...
library(stringr)
MT='A2'
species2=paste("M-scorzo-",MT,sep="")
species1=paste("Mv-lag-1253-",MT,sep="")

chroms_lag=c('MC01',"MC02-1", "MC02-2", 'MC12','MC16','MC03')
...
strata1=select(strata, c("contig_A2","start_A2","end_A2","colors"))
colnames(strata1)=c('contig','start','end','colors')
strata1$contig=strata1$contig %>% str_replace("MscorzoA2_", "")
...
#c("tig00000185","tig00000007","tig00000533", "tig00000008","tig00000531","tig00000010","tig00005667")
...
data_genes=read.table(paste('Positions_genes_',MT,'.txt',sep=''), header=T, as.is=T, sep='\t')
#data_pheromones=read.table(paste('Positions_pheromones_',MT,'.txt',sep=''), header=T, as.is=T, sep='\t')
#data_centromere=read.table(paste('Positions_centromeres_',MT,'.txt',sep=''), header=T, as.is=T, sep='\t')
#remove the centromere for the splitted contigs
# to_rm=c('MC12')
#data_centromere=data_centromere[-which(data_centromere$contig %in% to_rm ),]

#data_telomere=read.table(paste('Positions_telomeres_',MT,'.txt',sep=''), header=T, as.is=T, sep='\t')
...
new_names <- c(
  ...
  "tig00000008"="M-scor-PR1",
  "tig00000533"="M-scor-PR2",
  "tig00000531"="M-scor-PR3",
  "tig00000007"="tig007",
  "tig00005667"="M-scor-PR4",
  "tig00000010"="tig010",
  "MC03"="M-lag-HD",
  "MC12"="M-lag-PR1",
  "MC16"="M-lag-PR2",
...
pdf(file = paste("/Users/eliselucotte/desktop/server0/Assembly/ortholog_reconstruction/Scorzo/circos/circos_",MT,"_stratacolor.pdf",sep=''))#, width=200, height=200)
...
contig_color=c("grey","grey",'grey',"blue","purple","purple")
...
rcols=scales::alpha(ifelse(d$chrom_lag=='M-lag-HD',"blue",ifelse(d$chrom_lag %in%c('M-lag-PR1','M-lag-PR2'),"purple",'grey')),alpha=1)
