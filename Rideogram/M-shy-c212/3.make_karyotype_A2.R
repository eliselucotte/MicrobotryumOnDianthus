...
specie2='Mv-cat-C212-A2'
chroms_keep_species1=c('MC12','MC16','MC03')
chroms_keep_species2=c('h1tg000040l','h1tg000006l')

PR_chroms=c('M-shy-PR','PR1','PR2')
HD_chroms=c('M-shy-HD','HD')
dchrom <- c(
  "h1tg000040l"="M-shy-HD",
  "h1tg000006l"="M-shy-PR",
  "MC03"="HD",
  "MC12"="PR1",
  "MC16"="PR2"
)
...
d_centro=read.table('5.Rideogram/Mv-cat/bedfiles/Positions_centromeres_A2.txt', header=T, as.is=T, sep='\t')
d_legend=read.table('5.Rideogram/Mv-cat/bedfiles/legend_marker_A2.txt', header=T, as.is=T, sep='\t')
...
#change species name
#ideogram(karyotype = contigs, label=d_legend, label_type = "marker", output=paste('5.Rideogram/Mv-cat/',specie1,specie2,'karyotype.svg', sep='')) #overlaid=d_centro
ideogram(karyotype = contigs, overlaid=d_centro, label=d_legend, label_type = "marker", output=paste('5.Rideogram/Mv-cat/',specie1,specie2,'karyotype_A2.svg', sep=''))
#ideogram(karyotype = contigs, overlaid=d_centro, output=paste('5.Rideogram/Mv-cat/',specie1,specie2,'karyotype.svg', sep=''))

#convertSVG(paste('5.Rideogram/Mv-cat/',specie1,specie2,'karyotype_A2.svg', sep=''), device = "png")
