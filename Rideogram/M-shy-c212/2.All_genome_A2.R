...
d=read.table('3.circos/Mv-Cat/synteny_Mv-lag-1253-A2_Mv-cat-C212-A2.txt', header=T, as.is=T, sep='\t')
...
ideogram(karyotype = contigs, synteny = t_plot, output=paste('5.Rideogram/Mv-cat/All_contigs_',specie1,specie2,'.svg', sep=''))
convertSVG(paste('5.Rideogram/Mv-cat/All_contigs_',specie1,specie2,'.svg', sep=''), device = "png")
