...
PR_chroms=c('M-sup-PR2','M-sup-PR1','PR1','PR2')
...
d_centro=read.table('5.Rideogram/Mv-sup/with-extra-contig/bedfiles/Positions_centromeres_A1.txt', header=T, as.is=T, sep='\t')
d_legend=read.table('5.Rideogram/Mv-sup/with-extra-contig/bedfiles/legend_marker.txt', header=T, as.is=T, sep='\t')
...
ideogram(karyotype = contigs, overlaid=d_centro, label=d_legend, label_type = "marker", output=paste('5.Rideogram/Mv-sup/with-extra-contig/',specie1,specie2,'karyotype.svg', sep=''))
#ideogram(karyotype = contigs, overlaid=d_centro, output=paste('5.Rideogram/Mv-sup/',specie1,specie2,'karyotype.svg', sep=''))

convertSVG(paste('5.Rideogram/Mv-sup/',specie1,specie2,'karyotype.svg', sep=''), device = "png")
