...
PR_chroms=c('MC12','MC16','tig00000080','tig00000084')
HD_chroms=c('MC03','tig00000040')
# dchrom <- c(
#   "tig00000040"="M-sup-HD",
#   "tig00000084"="M-sup-PR1",
#   "tig00000080"='M-sup-PR2',
#   "MC03"="HD",
#   "MC12"="PR1",
#   "MC16"="PR2"
# )
...
contig1<-contig1 %>%
  mutate(Chr =  factor(Chr, levels = c('MC03','MC12','MC16',"MC01","MC04","MC02","MC11-1","MC11-2","MC11-3","MC05","MC09-1","MC09-2","MC07","MC08","MC06","MC14-2","MC14-1","MC13","MC10-1","MC10-2","MC15-1","MC15-2"))) %>%
  arrange(Chr)  

contig2<-contig2 %>%
  mutate(Chr =  factor(Chr, levels = c("tig00000040","tig00000080","tig00000082","tig00000084","tig00000090","tig00000109","tig00000012","tig00000111","tig00000019","tig00000022","tig00000029","tig00000030","tig00000033","tig00000034","tig00000035","tig00000070","tig00000097","tig00000100","tig00000101","tig00000104","tig00000105","tig00000117","tig00000118","tig00000119","tig00000122","tig00000124")))%>%
  arrange(Chr)
