...
path=sys.argv[2]+'/Orthologues/Orthologues_Mv-lag-1253-A1_final.cds.prot_longest_transcript'

list_chrom=['MC03','MC12','MC16']
for MAT in ['A1','A2']:
	f1=open(f'{path}/Mv-lag-1253-A1_final.cds.prot_longest_transcript__v__{name_species}-{MAT}_final.cds.prot_longest_transcript.tsv','r')
	f1.readline()
	for line in f1:
		line=line.split('\t')
		OG=line[0]
